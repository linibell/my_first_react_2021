...
#### 업데이트: [ugwe43to874nf4](https://www.reddit.com/user/ugwe43to874nf4) 라는 레딧유저님이 Virtual DOM 의 중요성을 더 알려주었습니다.
...
여기서 서술한 브라우저 작동방식에 대한 정보는 [여기서](http://www.html5rocks.com/en/tutorials/internals/howbrowserswork/) 발췌했습니다. 브라우저의 작동방식에 대해서 더 깊게 다루는 포스트에요. 읽어볼만한 가치가 있습니다. 제가 Virtual DOM 의 필요성을 이해하게 해주는데 큰 도움이 되었어요.
